# 无人负责 · 夜行列车（Nobody Did It）🎮

在线多人「鬼脚图 / 阿弥陀籤」抽签游戏——**一列永远不能停下的夜行列车，每个人都偷偷改轨，没人愿意承认最后是谁把列车送到了那个终点**。
大家轮流**扳道岔**（公开/暗轨/待命三选一）、选择/投票登车站、列车夜行全员同时揭晓；支持语音/吹气等搞怪画法，8-bit 复古像素风。
...
N 条轨道、底部 N 个终点站 → 轮流**扳道岔**（或暗轨施工/工务组待命）→ 选登车站（或投票/房主选）→ 车头灯照亮夜雾、列车下行遇道岔变轨到底部得结果。
完整规则： [GAME_RULES.md](GAME_RULES.md)

## 功能速览

- **行动三选一**：扳道岔（公开）/ 暗轨施工（偷偷改道，他人不可见）/ 工务组待命（不施工）——每人每局各 1 次，对外反馈一致 → 诈唬博弈
- **雾幕**：同一条轨道反复纠缠（或暗轨扎堆）触发纠缠度 → 该行生成 glitch 故障雾区，**线对他人不可读**（排雷推理）
- **事故调查回放**：揭晓后每个玩家看到列车经历的岔道统计（谁铺了几次岔道、含几条暗轨）+ 金色金句「没有人对把列车送到这里负全责——但每个人都帮了一点忙」
- **两种施工轮次**：多轮（轮流一人一槽，夜色雾从上至下覆盖旧视野）/ 单轮（槽位交错预分配，一次交接填完）
- **三种选择模式**：各自选择 / 房主选择 / 投票选择（透明化 + 归票动画 + 房主票 1.5）
- **搞怪画法**：点击 / 🎤语音 / 💨吹气 / 📱倾斜 / 🎲命运（声音实时广播给其他玩家）
- **仪式感**：车头灯揭晓（夜色雾被照亮消散）、全员同时走线、3s 公示、chip tune 音效、CRT 扫描线
- **夜色雾开关**：房主可在大厅切换迷雾开启/关闭（开启时旧轨道沉入夜色、起点槽呼吸灯浮于雾上）
- **自定义背景**：房主上传任意图片，像素化后低透明度衬在画板下方（纯外观，不影响走线）
- **容错**：超时自动扳道岔、退出转托管、断线重连
